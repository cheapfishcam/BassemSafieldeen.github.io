...
cdef complex spectral2(double w, double t): return 0.15 * (w >= 0)
...
def cy_td_ode_rhs(
    ...
    dense_add_mult(Ac0, A0, 1)
    dense_add_mult(Ac0, A1, 1)
    br_term_mult(t, Ac0, evecs, skew, dw_min, spectral0, eig_vec, out, nrows, 1, 0.1, 1e-12)
