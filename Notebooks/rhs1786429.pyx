...
def cy_td_ode_rhs(
    ...
    spmvpy(&data0[0], &idx0[0], &ptr0[0], &vec[0], 0.1j*sin(t), out, num_rows)
    spmvpy(&data1[0], &idx1[0], &ptr1[0], &vec[0], -0.1j*sin(t), out, num_rows)
    spmvpy(&data2[0], &idx2[0], &ptr2[0], &vec[0], 1.0, out, num_rows)
